...
<fmt:bundle basename="by.bsu.guglya.library.resources.gui">
    ...
    <div>
        <div class="add-book-form">
            <form name="addBook" action="LibraryServlet" method="POST">
                ...
                <input class="text-width" type="text" name="author" placeholder=<fmt:message
                        key="catalog.text.author"/>/><br/><br/>

                <div><fmt:message key="catalog.year.full"/></div>
                <input class="text-width" type="text" name="year" placeholder=<fmt:message
                        key="catalog.text.year"/>/><br/><br/>
                ...
                <input class="text-width" type="text" name="quantity" placeholder=<fmt:message
                        key="catalog.text.quantity"/>/><br/><br/>

                <button type="submit" class="btn btn-info"><fmt:message key="catalog.addBookToCatalog"/></button>
            </form>
        </div>

        <div class="text-message"><h2>${emptyFieldMessage}</h2></div>
